...
class WizardsControllerTest < ActionController::TestCase
  ...
  test "should create wizard" do
    assert_difference('Wizard.count') do
      post :create, wizard: { field1: @wizard.field1, field2: @wizard.field2, field3: @wizard.field3, field4: @wizard.field4, field5: @wizard.field5, field6: @wizard.field6 }
    end
  ...
  test "should update wizard" do
    put :update, id: @wizard, wizard: { field1: @wizard.field1, field2: @wizard.field2, field3: @wizard.field3, field4: @wizard.field4, field5: @wizard.field5, field6: @wizard.field6 }
    assert_redirected_to wizard_path(assigns(:wizard))
  end
